    ...
    <footer className='border-top' style={{backgroundColor:"#FBFBFB"}} >
        ...
        <div className='container  mt-5'style={{color:"#424242",fontSize:"14px"}}>
            <div className='row mt-5'>
                <div className='col'>
                    <img src='media/logo.svg' style={{width:"50px"}}></img>
                ...
                <div className='col'>
                    ...
                    <a href=''className='text-muted' style={{textDecoration:"none"}}>Presh & media</a><br/>
            ...
            <div className='row mb-3'>
                ...
                <div className='col'>
                    <a href=''className='text-muted' style={{textDecoration:"none"}}>NSE</a><br/>

                </div>
                <div className='col'>
                    <a href=''className='text-muted' style={{textDecoration:"none"}}>BSE</a><br/>
                    </div>
                <div className='col'>
                    <a href=''className='text-muted' style={{textDecoration:"none"}}>MCX</a><br/>
                </div>
                <div className='col'>
                    <a href=''className='text-muted' style={{textDecoration:"none",textWrap:"nowrap"}}>Terms & condition</a><br/>
                </div>
                <div className='col'>
