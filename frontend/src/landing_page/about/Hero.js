    ...
    return ( 
        <div className='cantainer'>
            <div className='row p-5 mb-5'>
                <h1 className='fs-2  mt-5 text-center text-muted'>
                    We pioneerd the discount broking model in India,<br/>
            ...
            <div className='row p-5 mt-5 border-top ' style={{lineHeight:"1.8",fontSize:"1em"}}>
                ...
                <div className='col-4 text-muted'>
                    <p>We kick-started operations on the 15th of August, 
                       ...
                       face in India in terms of cost, support, and technology. We named the
                       company TradePath, a combination of Zero and "Rodha", the Sanskrit word
                       for barrier.
                    </p>
                    ...
                    <p>Over 1.6+ crore clients place billions of orders every year through our powerful
                        ecosystem of investment platforms, contributing over 15% of all Indian retail trading volumes.
                    </p>
                </div>
                <div className='col-4 text-muted'>
                    <p>
